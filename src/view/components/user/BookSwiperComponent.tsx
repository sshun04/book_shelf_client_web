...
export default function BookSwiper(props: BookSwiperProps) {
        ...
        <section>
            <div className="container">
                <div className="sectionHeader">
                    <h5>{props.filterHeader}<span className="ml-2">({props.numberOfBooks}冊)</span></h5>
                    <div className="checkAll float-right"><a onClick={props.onClickMore}>もっと見る</a></div>
                </div>
